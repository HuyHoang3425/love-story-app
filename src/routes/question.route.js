...
questionRouter.post('/', auth, authAdmin,validate(QuestionValidation.createQuestion), QuestionController.createQuestion)

questionRouter.put('/:questionId', auth, authAdmin,validate(QuestionValidation.editQuestion), QuestionController.editQuestion)
